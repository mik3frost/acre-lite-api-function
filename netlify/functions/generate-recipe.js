    ...
    try {
        ...
        const generatedRecipe = `
            <div style="padding: 20px; background-color: #fff0d6; border: 1px solid #a87e5b; border-radius: 8px;">
                ...
                <hr>
                <p><strong>Protocol:</strong> Start by combining your core ingredients (proteins and vegetables) with a generous amount of seasoning (salt, pepper, and herbs). Roast on a single sheet pan at 400°F for 25 minutes, or pan-sear for 15 minutes. Enjoy your simple, reliable meal!</p>
            </div>
        `;
        // ----------------------------------------------------
